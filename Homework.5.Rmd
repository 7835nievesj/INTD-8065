...
1.	Run the t test for the comparison of control diet and high fat diet 
    presented in page 51-52 of Irizarry and Love (2015) assuming equality of
    variances. 
...
3.	Use the function power.t.test in library pwr for calculating the power 
        obtained by simulation in page 64 by Irizarry and Love for N=12 and 
        alpha = 0.05. 
...
4.	Use now  power.t.test for calculating the power for N=5, 10, 15, 20, 25,
        ...
        Overimpose your results to the graph generated in the book using red lines and
        dots.
...
5.	Repeat part 3. for the graph of power for different values of alphas shown in              
    page 67.
